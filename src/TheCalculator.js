...
const TOOLS_DATA = {
  Midjourney: {
   ...
   "Higgsfield": {
    ...
    features: [
      ...
      { name: "Image - Nano Banana", creditsPerGen: 0 },
      { name: "Image - Flux Kontext Max", creditsPerGen: 3 },
      { name: "Image - ChatGPT", creditsPerGen: 2 },
      { name: "Image - Multi-Reference", creditsPerGen: 3 },
      { name: "Image - WAN 2.2", creditsPerGen: 1 },
      { name: "Video - Higgsfield Lite", creditsPerGen: 5 },
      { name: "Video - Higgsfield Standard", creditsPerGen: 10 },
      { name: "Video - Higgsfield Turbo", creditsPerGen: 7 },
      { name: "Video - Kling 2.1", creditsPerGen: 5 },
      { name: "Video - Kling 2.1 Master", creditsPerGen: 25 },
      { name: "Video - Wan 2.2 Fast", creditsPerGen: 7 },
      { name: "Video - Wan 2.2", creditsPerGen: 14 },
      { name: "Video - Minimax Hailuo 02 Fast", creditsPerGen: 5 },
      { name: "Video - Minimax Hailuo 02", creditsPerGen: 8 },
      { name: "Video - Seedance Pro", creditsPerGen: 8 },
  ...
  "Flux AI": {
    ...
    features: [
      ...
      { name: "Kontext(PRO) - Texto to Image", creditsPerGen: 50 },
      { name: "Kontext(MAX) - Texto to Image", creditsPerGen: 100 },
      ...
      { name: "Flux Canny/Depth", creditsPerGen: 100 },
      { name: "Flux Redux", creditsPerGen: 150 },
      { name: "Flux.1 [pro] Canny/Depth", creditsPerGen: 60 },
      { name: "Flux.1 [schnell] Redux", creditsPerGen: 30 },
      { name: "Flux.1 [dev] Redux", creditsPerGen: 30 },
      { name: "Flux.1 [pro] Redux", creditsPerGen: 60 },
      { name: "Flux1.1 [pro] Redux", creditsPerGen: 60 },
      { name: "Flux1.1 [pro] ultra Redux", creditsPerGen: 120 },
      { name: "Flux Realism", creditsPerGen: 50 },
      { name: "Video STD 1.0 (5s)", creditsPerGen: 100 },
      { name: "Video STD 1.6 (5s)", creditsPerGen: 200 },
      { name: "Video STD 2.1 (5s)", creditsPerGen: 200 },
      { name: "Video STD 2.1 (10s)", creditsPerGen: 400 },
      { name: "Video PRO 1.6 (5s)", creditsPerGen: 350 },
      { name: "Video PRO 1.6 (10s)", creditsPerGen: 700 },
      { name: "Video PRO 2.1 (5s)", creditsPerGen: 1000 },
      { name: "Video PRO 2.1 (10s)", creditsPerGen: 2000 },
      { name: "AI Kiss Video", creditsPerGen: 200 },
      { name: "AI Hug Video", creditsPerGen: 200 },
      { name: "AI Kung Fu Video", creditsPerGen: 200 },
      { name: "AI Happy New Year Avatar", creditsPerGen: 40 },
      { name: "AI Happy New Year Image", creditsPerGen: 10 },
      { name: "Ideogram AI", creditsPerGen: 100 },
      { name: "Ideogram AI Remix", creditsPerGen: 100 },
      { name: "Gemini Flash Edit Image", creditsPerGen: 10 },
      { name: "Action Figure Generator", creditsPerGen: 40 },
      { name: "Ghibli AI", creditsPerGen: 40 },
      { name: "AI Action Figure Video", creditsPerGen: 200 },
      { name: "AI Ghibli Art Video", creditsPerGen: 200 },
      { name: "Barbie Doll Box", creditsPerGen: 40 },
      { name: "AI Plush Toy", creditsPerGen: 40 },
      { name: "AI Simpsons style", creditsPerGen: 40 },
      { name: "AI Photo to Cartoon", creditsPerGen: 40 },
      { name: "Imagen 4", creditsPerGen: 60 },
      { name: "Kontext(PRO) - Image Editing", creditsPerGen: 50 },
      { name: "Kontext(MAX) - Image Editing", creditsPerGen: 100 },
      { name: "Kontext(PRO) - Multi Images Editing", creditsPerGen: 50 },
      { name: "Kontext(MAX) - Multi Images Editing", creditsPerGen: 100 },
      { name: "VEO3 Text to Video", creditsPerGen: 3000 },
      { name: "VEO3 Text to Video - Audio", creditsPerGen: 4500 },
      { name: "VEO3 Image to Video", creditsPerGen: 3000 },
      { name: "VEO3 Image to Video - Audio", creditsPerGen: 4500 },
      { name: "AI Hair Cut", creditsPerGen: 50 },
      { name: "AI Headshot Generator", creditsPerGen: 50 },
      { name: "Old Photo Restore", creditsPerGen: 50 },
      { name: "AI Product Photography", creditsPerGen: 40 },
      { name: "Hailuo 2.0 Standard (6s)", creditsPerGen: 250 },
      { name: "Hailuo 2.0 Standard (10s)", creditsPerGen: 500 },
      { name: "Hailuo 2.0 Pro (6s)", creditsPerGen: 400 },
      { name: "Hailuo 2.0 Pro (10s)", creditsPerGen: 800 },
      { name: "Seedance 1.0 Lite (5s)", creditsPerGen: 150 },
      { name: "Seedance 1.0 Lite (10s)", creditsPerGen: 300 },
      { name: "AI French Kiss Video", creditsPerGen: 200 },
      { name: "Video STD 1.6 (10s)", creditsPerGen: 400 },
      { name: "Kling 2.1 Standard (5s)", creditsPerGen: 200 },
      { name: "Kling 2.1 Standard (10s)", creditsPerGen: 400 },
      { name: "Kling 2.1 Master (5s)", creditsPerGen: 1000 },
      { name: "Kling 2.1 Master (10s)", creditsPerGen: 2000 },
      { name: "Flux Kontext Dev", creditsPerGen: 30 },
      { name: "Flux Kontext Dev 2K", creditsPerGen: 120 },
      { name: "Flux Kontext Lora", creditsPerGen: 40 },
      { name: "Flux Kontext Lora 2K", creditsPerGen: 40 },
      { name: "Earth Zoom Out Video (Turbo)", creditsPerGen: 875 },
      { name: "Flux Krea", creditsPerGen: 30 },
      { name: "Flux Krea Image to Image", creditsPerGen: 30 },
      { name: "Flux Krea Redux", creditsPerGen: 30 },
      { name: "Seedance 1.0 Lite Text to Video (5s)", creditsPerGen: 150 },
      { name: "Seedance 1.0 Lite Text to Video (10s)", creditsPerGen: 300 },
      { name: "Google VEO3 Fast (8s) [16:9]", creditsPerGen: 800 },
      { name: "Video STD 1.5 (5s)", creditsPerGen: 200 },
      { name: "Google VEO3 (8s) [16:9]", creditsPerGen: 3000 },
      { name: "Hedra Video (540p)", creditsPerGen: 20 },
      { name: "Hedra Video (720p)", creditsPerGen: 40 },
      { name: "Earth Zoom Out", creditsPerGen: 875 },
      { name: "Eyes In", creditsPerGen: 875 },
      { name: "Building Explosion", creditsPerGen: 875 },
  ...
  Runway: {
    ...
    features: [
      ...
      { name: "Geração de 1s Gen-4 Video", creditsPerGen: 12 },
      { name: "Geração de 1s Gen-4 Turbo Video", creditsPerGen: 5 },
      { name: "Geração de 1s Act-Two", creditsPerGen: 5 },
      { name: "Geração de 1s Veo 3 com áudio", creditsPerGen: 75 },
      { name: "Geração de 1 imagem Gen-4 1080p", creditsPerGen: 8 },
  ...
  "Kling AI": {
    ...
    features: [
      { name: "Kolors 1.0 - Text to Image", creditsPerGen: 0.2 },
      { name: "Kolors 1.0 - Image Reference", creditsPerGen: 0.3 },
      { name: "Kolors 1.5 - Text to Image", creditsPerGen: 1 },
      { name: "Kolors 1.5 - Image Reference", creditsPerGen: 2 },
      { name: "Kolors 2.0 - Text to Image", creditsPerGen: 1 },
      { name: "Kolors 2.0 - Elements", creditsPerGen: 4 },
      { name: "Kolors 2.0 - Restyle", creditsPerGen: 2 },
      { name: "Kolors 2.1 - Text to Image", creditsPerGen: 1 },
      { name: "Kling 1.5 - Text to Video (Standard) 5s", creditsPerGen: 20 },
      { name: "Kling 1.5 - Text to Video (Standard) 10s", creditsPerGen: 40 },
      { name: "Kling 1.5 - Text to Video (Professional) 5s", creditsPerGen: 35 },
      { name: "Kling 1.5 - Text to Video (Professional) 10s", creditsPerGen: 70 },
      { name: "Kling 1.5 - Image to Video (Standard) 5s", creditsPerGen: 20 },
      { name: "Kling 1.5 - Image to Video (Standard) 10s", creditsPerGen: 40 },
      { name: "Kling 1.5 - Image to Video (Professional) 5s", creditsPerGen: 35 },
      { name: "Kling 1.5 - Image to Video (Professional) 10s", creditsPerGen: 70 },
      { name: "Kling 1.6 - Text to Video (Standard) 5s", creditsPerGen: 20 },
      { name: "Kling 1.6 - Text to Video (Standard) 10s", creditsPerGen: 40 },
      { name: "Kling 1.6 - Text to Video (Professional) 5s", creditsPerGen: 35 },
      { name: "Kling 1.6 - Text to Video (Professional) 10s", creditsPerGen: 70 },
      { name: "Kling 1.6 - Image to Video (Standard) 5s", creditsPerGen: 20 },
      { name: "Kling 1.6 - Image to Video (Standard) 10s", creditsPerGen: 40 },
      { name: "Kling 1.6 - Image to Video (Professional) 5s", creditsPerGen: 35 },
      { name: "Kling 1.6 - Image to Video (Professional) 10s", creditsPerGen: 70 },
      { name: "Kling 1.6 - Multi-Elements (Standard) 5s", creditsPerGen: 30 },
      { name: "Kling 1.6 - Multi-Elements (Professional) 5s", creditsPerGen: 50 },
      { name: "Kling 2.1 - Image to Video (Standard) 5s", creditsPerGen: 20 },
      { name: "Kling 2.1 - Image to Video (Standard) 10s", creditsPerGen: 40 },
      { name: "Kling 2.1 - Image to Video (Professional) 5s", creditsPerGen: 35 },
      { name: "Kling 2.1 - Image to Video (Professional) 10s", creditsPerGen: 70 },
      { name: "Kling 2.1 Master - Text to Video 5s", creditsPerGen: 60 },
      { name: "Kling 2.1 Master - Text to Video 10s", creditsPerGen: 120 },
      { name: "Kling 2.1 Master - Image to Video 5s", creditsPerGen: 100 },
      { name: "Kling 2.1 Master - Image to Video 10s", creditsPerGen: 200 },
    ],
  },
  Minimax: {
    plans: [
    ...
    >
      ...
      <img
        ...
        style={{
          ...
          transform: isMobile ? "translateX(160%)" : "translateX(-360%)", // Centraliza verticalmente
